...
import sys
import getpass
#  xmlrpclib renamed to xmlrpc.client in Python 3
...
def main(parameters, arguments):
    ...
    try:
        #  Use 'with' for file handling, binary read
        with open(arguments[0], 'rb') as f:
            plugin_data = xmlrpc.client.Binary(f.read())
        plugin_id, version_id = server.plugin.upload(plugin_data)
