...
@Component({
  selector: "app-simple-farm-details",
  imports:[CommonModule, ReactiveFormsModule, FormsModule,AddressModule, DocumentModule, ProjectModule],
  templateUrl: "./simple-farm-details.component.html",
  styleUrls: ["./simple-farm-details.component.scss"]
})

export class SimpleFarmDetailsComponent implements OnInit {
  @Input('farm')
  farm: any = {};
