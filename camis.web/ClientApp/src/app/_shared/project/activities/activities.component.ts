...
export class ActivitiesComponent implements OnInit {
  ...
  get todayLeft(): number {
    ...
    return Number.isFinite(val) ? Math.round(val * 1000) / 1000 : 0;
  }
  ...
  get todayColor(): string {
    return this.todayLeft < 90 ? 'rgb(240,200,70)' : 'rgb(240,70,70)';
  }
