...
export interface ReportRequestModel {
  ...
  // Fix property names to match C# model
  region: string | null;
  regions: string[] | null; // Add missing property
  zone: string | null;
  woreda: string | null;

  dates: DateParam[] | null; // Change from Object[] to DateParam[]
  farmSizes: SizeParam[] | null; // Change from Object[] to SizeParam[]
