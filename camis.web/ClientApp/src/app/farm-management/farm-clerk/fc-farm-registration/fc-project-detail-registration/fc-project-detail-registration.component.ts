...
@Component({
  ...
  imports:[CommonModule, ReactiveFormsModule, FormsModule,ActivitiesComponent],
...
export class FcProjectDetailRegistrationComponent implements OnInit {
  ...
  constructor (private router: Router, private api: ProjectApiService, private fb: FormBuilder,   private keyCase: ObjectKeyCasingService) {
  }
