...
import {ContractUpdateFormComponent} from "./contract-update-form/contract-update-form.component";

@Component({
  selector: "app-renew-contract",
  imports: [CommonModule, ReactiveFormsModule, FormsModule, FarmDetailComponent, DocumentDetailComponent, ContractUpdateFormComponent],
