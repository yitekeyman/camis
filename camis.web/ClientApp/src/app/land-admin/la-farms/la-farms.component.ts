...
@Component({
  selector: 'app-la-farms',
  templateUrl: 'la-farms.component.html'
})
export class LaFarmsComponent implements OnInit {
  ...
  openDetail(farmId: string) {
    return this.router.navigateByUrl(`/land-admin/land-selection/new/${farmId}`);
  }
