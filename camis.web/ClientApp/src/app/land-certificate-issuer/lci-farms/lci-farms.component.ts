...
@Component({
  selector: 'app-lci-farms',
  templateUrl: 'lci-farms.component.html'
})
export class LciFarmsComponent implements OnInit {
  ...
  openDetail(farmId: string) {
    return this.router.navigateByUrl(`/land-certificate-issuer/farm/${farmId}`);
  }
