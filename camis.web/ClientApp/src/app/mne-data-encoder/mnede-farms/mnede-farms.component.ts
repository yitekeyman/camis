...
@Component({
  selector: 'app-mnede-farms',
  templateUrl: 'mnede-farms.component.html'
})
export class MnedeFarmsComponent implements OnInit {
  ...
  openDetail(farmId: string) {
    return this.router.navigateByUrl(`/mne-data-encoder/farm/${farmId}`);
  }
