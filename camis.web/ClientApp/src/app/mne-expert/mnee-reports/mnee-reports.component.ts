...
@Component({
    selector: 'app-mnee-reports',
    templateUrl: 'mnee-reports.component.html'
})
export class MneeReportsComponent implements OnInit {
    ...
    openDetail(reportId: string) {
        return this.router.navigate([`mne-expert/report/${reportId}`]);
    }
