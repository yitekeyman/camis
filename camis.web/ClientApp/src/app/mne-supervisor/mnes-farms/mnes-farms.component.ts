...
@Component({
  selector: 'app-mnes-farms',
  templateUrl: 'mnes-farms.component.html'
})
export class MnesFarmsComponent implements OnInit {
  ...
  openDetail(farmId: string) {
    return this.router.navigateByUrl(`/mne-supervisor/pr/new/request?farmId=${farmId}`);
  }
