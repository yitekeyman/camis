...
@Component({
    selector: 'app-mnes-reports',
    templateUrl: 'mnes-reports.component.html'
})
export class MnesReportsComponent implements OnInit {
    ...
    openDetail(reportId: string) {
        return this.router.navigateByUrl(`mne-supervisor/report/${reportId}`);
    }
