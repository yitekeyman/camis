...
namespace camis.web.Controllers
{
    public class CmssController : BaseController
    {
        ...
        public IActionResult TaskList(String sid)
        {
            ...
            var tl = _facade.GetParcelSplitTaskList();
            return View(tl);
        }
        ...
        public IActionResult ProcessSplit(String taskid, String sid)
        {
            ...
            var data = _facade.GetParcelSplitData(Guid.Parse(taskid));
        ...
        [HttpPost]
        public IActionResult SplitParcel([FromBody] LandBankFacadeModel.SplitParcelData data, [FromQuery] String sid,
