...
export class ActivityItemComponent implements OnInit {
  ...
  get create_valuedProgressVariableTypes(): any[] {
    return this._calculateValuedProgressVariableTypes(this.create_varTargets, this.create_varWeights, this.create_varNames);
  }

  get edit_valuedProgressVariableTypes(): any[] {
    return this._calculateValuedProgressVariableTypes(this.edit_varTargets, this.edit_varWeights, this.edit_varNames);
  }

  private _calculateValuedProgressVariableTypes(targets: any, weights: any, customVariableNames: string): any[] {
    const ret: any = [];
    const details = this.extractDetails(targets, weights, customVariableNames);
  ...
  create(): void {
    ...
    if (this.addFromTemplate == 'YES') {
      ...
      newChildActivity = {
        ...
        schedules,
        activityPlanDetails: this.extractDetails(this.create_varTargets, this.create_varWeights, this.create_varNames),
        children: []
      };
    }
    if (!newChildActivity) {
  ...
  edit(): void {
    ...
    this.activity = {
      ...
      schedules,
      activityPlanDetails: this.extractDetails(this.edit_varTargets, this.edit_varWeights, this.edit_varNames),
  ...
  extractDetails(targets: any, weights: any, customVariableNames: any): any[] {
    const ret = [];
